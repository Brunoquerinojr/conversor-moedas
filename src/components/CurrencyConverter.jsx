...
const CurrencyConverter = () => {
    ...
    // Estado para armazenar a valor a ser convertido
    const [amount, setAmount] = useState("1");

    // Estado para armazenar a valor a ser convertido
    const [convertedAmount, setConvertedAmount] = useState(null);

    // Efeito para buscar as taxas de cãmbio da API
    useEffect(() => {
        axios
        .get("https://v6.exchangerate-api.com/v6/9285baee15d650c83811ae29/latest/USD")
        .then((response) => {
